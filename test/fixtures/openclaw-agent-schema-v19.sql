-- AgentSession fixture: OpenClaw current agent schema (agent schema version 19)
-- Schema body copied from the official upstream file; this AgentSession
-- provenance header is not part of the upstream bytes:
--   openclaw/openclaw src/state/openclaw-agent-schema.sql
-- Verified at: 2026-09-03
--   HEAD f92a12c5813fb880ed6a05c4a728fd5f4ccc5473 (tag v2026.8.2 = 2e2aa1136152d8462f242270825cbfad63d9c6dc,
--   newest main 2d9796d66c4358d7175761b581077fbd8fe16116)
--   sha256 54fa65dc23576fcb20bc77f714d10598a7240ad28b7edd4fe4c39995dc96f61e
-- The upstream file is generated from the repository schema; this fixture keeps the
-- object definitions used by current-format readers and is intentionally injected
-- into an in-test SQLite database (never written to provider storage).
