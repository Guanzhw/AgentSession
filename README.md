...
| Claude Code | 可管理 | `~/.claude/transcripts/` + `~/.claude/projects/` | 浏览、搜索、收藏、重命名、删除、回收站、token 统计、ReACT、Trace、Flow、可用 transcript 的子 agent、分析提示词证据 |
| Codex CLI | 可管理 | `~/.codex/sessions/**/*.jsonl` | 浏览、搜索、收藏、重命名、删除、回收站、token 统计、ReACT、Flow、嵌套子 agent |
| Gemini CLI | 可管理 | `~/.gemini/tmp/*/chats/*.json` | 浏览、搜索、收藏、重命名、删除、回收站、token 统计、ReACT、Flow |
