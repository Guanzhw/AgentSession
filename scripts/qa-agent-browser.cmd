...
if not "%AGENTSESSION_QA_BASH_PATH%"=="" (
  set "QA_BASH=%AGENTSESSION_QA_BASH_PATH%"
  ...
  echo Git Bash or Cygwin Bash is required. Set AGENTSESSION_QA_BASH_PATH to bash.exe.
  exit /b 1
)

if "%AGENTSESSION_QA_PORT%"=="" set "AGENTSESSION_QA_PORT=3470"
