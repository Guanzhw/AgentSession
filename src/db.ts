...
export function getSessionSafe(id: any, pathOverride: string | undefined = undefined) {
  ...
  return {
    ...
    summary_additions: row.summary_additions == null ? null : row.summary_additions,
    summary_deletions: row.summary_deletions == null ? null : row.summary_deletions,
    summary_files: row.summary_files == null ? null : row.summary_files,
