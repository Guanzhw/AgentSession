...
export const __I18N__ = {
  en: {
    ...
    execution_loading: "Loading execution…",
    execution_load_failed: "Execution could not be loaded.",
  ...
  zh: {
    ...
    execution_loading: "正在加载执行视图…",
    execution_load_failed: "执行视图加载失败。",
    resume_opened: "终端已打开",
