...
This negative conclusion holds only for the audited snapshot. DSH alpha.5, OpenClaw current SQLite, Pi 0.84.4, Claude Code 2.1.207, and OpenCode 1.17.11 local data are now snapshot-verified (2026-09-03) and likewise show no origin slices; Codex 0.152.1 and Hermes remote HEAD remain **pending/unknown** — never "no slices".
